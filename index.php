...
<body id="page-top">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    ...
                    <?php if (isset($_SESSION['login_user_id'])) : ?>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=order_list"><i class="fa-solid fa-list-radio"></i>Orders</a></li>
    ...
    <footer class="bg-light py-5">
        <div class="container">
            <div class="small text-center text-muted">Copyright © 2020 - Food Ordering system</div>
        </div>
    </footer>
