...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> Website Users</a>
				<a href="index.php?page=customers" class="nav-item "><span class='icon-field'><i class="fa fa-users"></i></span>Customers</a>
